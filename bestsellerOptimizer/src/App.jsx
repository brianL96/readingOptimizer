...
const App = () => {
  ...
  return (
    ...
    <div className='h-auto min-w-max bg-zinc-300'>
      ...
      <div className='flex flex-row justify-start h-auto w-full mt-4'>

        <div className='hidden fullFeaturesScreen:flex flex-col items-center h-screen w-72 fixed'>

          <div className='flex flex-col justify-start h-60 w-56 bg-white border border-black overflow-auto overscroll-none'>
