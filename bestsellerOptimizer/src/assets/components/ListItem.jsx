...
const ListItem = ({image, audiobookLength, addBookToCalculator, index, readingSpeed, dailyHours, bookName, bookAuthor}) => {
  ...
  }, [image, audiobookLength, index, readingSpeed, dailyHours, bookName, bookAuthor]);
