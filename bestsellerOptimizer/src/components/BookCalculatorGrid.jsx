...
const BookCalculatorGrid = ({bookList, deleteBookFromCalculator}) => {
    ...
    function loadList(){
        ...
        while(index < length){
            ...
            smallArr.push(
                <BookGridObject title={books[index].title} author={books[index].author} bookCover={books[index].bookCover} wordcount={books[index].wordcount} percentage={books[index].percentage} deleteBookFromCalculator={deleteBookFromCalculator} amazonLink={books[index].amazonLink}/>
            );
