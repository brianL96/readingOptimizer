...
const BookCalculator = ({booksInCalculator, setReadingSpeed, setDailyHours, setMonthSize, deleteBookFromCalculator}) => {
    ...
    function fileStuff(e){
      ...
      let arr = [
        <a className='cursor-pointer text-blue-200 underline' href={url} download={'justAnExample.csv'}>readingSchedule.csv</a>
      ];
  ...
  return (
    ...
    <div className='flex flex-col w-200 min-h-120 h-auto mt-5 mb-5 bg-amber-900 border border-black'>
      ...
      <div className='flex flex-row justify-center w-full h-16'>
        <div className='flex flex-row justify-start w-160 h-16'>
          <div>
