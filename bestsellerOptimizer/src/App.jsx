...
const App = () => {
  ...
  return (
    ...
    <div className='h-auto min-w-max bg-zinc-300'>
      <div className='flex flex-row justify-start h-auto w-full'>

        <div className='hidden fullFeaturesScreen:flex flex-row justify-center h-116 w-72 fixed'>

          <div className='flex flex-col justify-start mt-16 h-60 w-56 bg-white border border-black overflow-auto overscroll-none'>
        ...
        <div className='h-auto w-200 ml-5 fullFeaturesScreen:ml-72'>
