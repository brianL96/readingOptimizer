...
const BookCalculator = ({booksInCalculator, setReadingSpeed, setDailyHours, setMonthSize, deleteBookFromCalculator}) => {
  ...
  return (
    ...
    <div className='flex flex-col w-160 fullBoxScreen:w-200 min-h-120 h-auto mt-5 mb-5 bg-amber-900 border border-black shadow-2xl shadow-gray-500'>
      ...
      <div className='flex flex-row justify-center w-full h-16'>
        <div className='flex flex-row justify-start w-150 fullBoxScreen:w-160 h-16'>
          <div>
            <button onClick={(e) => {fileStuff(e)}} className='flex flex-row justify-center items-center bg-green-700 w-28 h-12 transition ease-in-out delay-150 hover:scale-110 text-white rounded-lg'>Export To CSV</button>
          </div>
