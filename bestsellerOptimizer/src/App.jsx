...
import ListContainer from './assets/components/ListContainer';
import BookCalculator from './assets/components/BookCalculator';
    ...
    <div className='flex flex-row justify-start h-auto w-full bg-zinc-300'>
      ...
      <div className='h-auto w-200 ml-72'>
        <div className='flex flex-row justify-center w-full h-auto mb-10'>
          <BookCalculator booksInCalculator={booksInCalculator} setReadingSpeed={setReadingSpeed} setDailyHours={setDailyHours} deleteBookFromCalculator={deleteBookFromCalculator}/>
        </div>
